import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { l as prefixStorage, m as useStorage, n as useNitroOrigin, o as emojiCache, q as useOgImageRuntimeConfig, f as createError, v as fetchIsland, w as normaliseFontInput, x as withTrailingSlash, g as getQuery, y as handleCacheHeaders, z as setHeaders, A as setHeader, B as hash, C as parseURL, D as setResponseHeader, E as proxyRequest, F as sendRedirect, G as resolveContext, H as H3Error } from './nitro.mjs';
import { renderSSRHead } from '@unhead/ssr';
import { createHeadCore } from 'unhead';

const theme = {"colors":{"light":{"background":{"primary":"#9ca3af","secondary":"#d1d5db","tertiary":"#e5e7eb"},"text":{"primary":"#242121","secondary":"#374151","muted":"#6B7280"}},"dark":{"background":{"primary":"#374151","secondary":"#4b5563","tertiary":"#6b7280"},"text":{"primary":"#5188ff","secondary":"#D1D5DB","muted":"#f9fafb","negative":"#be123c"}},"primary":{"50":"rgb(var(--color-primary-50) / <alpha-value>)","100":"rgb(var(--color-primary-100) / <alpha-value>)","200":"rgb(var(--color-primary-200) / <alpha-value>)","300":"rgb(var(--color-primary-300) / <alpha-value>)","400":"rgb(var(--color-primary-400) / <alpha-value>)","500":"rgb(var(--color-primary-500) / <alpha-value>)","600":"rgb(var(--color-primary-600) / <alpha-value>)","700":"rgb(var(--color-primary-700) / <alpha-value>)","800":"rgb(var(--color-primary-800) / <alpha-value>)","900":"rgb(var(--color-primary-900) / <alpha-value>)","950":"rgb(var(--color-primary-950) / <alpha-value>)","DEFAULT":"rgb(var(--color-primary-DEFAULT) / <alpha-value>)"},"cool":{"50":"#f9fafb","100":"#f3f4f6","200":"#e5e7eb","300":"#d1d5db","400":"#9ca3af","500":"#6b7280","600":"#4b5563","700":"#374151","800":"#1f2937","900":"#111827","950":"#030712"},"gray":{"50":"rgb(var(--color-gray-50) / <alpha-value>)","100":"rgb(var(--color-gray-100) / <alpha-value>)","200":"rgb(var(--color-gray-200) / <alpha-value>)","300":"rgb(var(--color-gray-300) / <alpha-value>)","400":"rgb(var(--color-gray-400) / <alpha-value>)","500":"rgb(var(--color-gray-500) / <alpha-value>)","600":"rgb(var(--color-gray-600) / <alpha-value>)","700":"rgb(var(--color-gray-700) / <alpha-value>)","800":"rgb(var(--color-gray-800) / <alpha-value>)","900":"rgb(var(--color-gray-900) / <alpha-value>)","950":"rgb(var(--color-gray-950) / <alpha-value>)"}}};
