...
import { createConsola as createConsola$2 } from 'consola/core';
...
function withoutLeadingSlash(input = "") {
  return (hasLeadingSlash$1(input) ? input.slice(1) : input) || "/";
}
...
function useBase(base, handler) {
  ...
  return eventHandler(async (event) => {
    ...
    event._path = withoutBase$1(event.path || "/", base);
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "2dae6628-e2fe-46ea-8c0e-bf7b4284757f",
...
function wrapToPromise$1(value) {
  if (!value || typeof value.then !== "function") {
    return Promise.resolve(value);
  }
  return value;
}
function asyncCall$1(function_, ...arguments_) {
  try {
    return wrapToPromise$1(function_(...arguments_));
  } catch (error) {
...
function stringify$1(value) {
  ...
  if (isPureObject$1(value) || Array.isArray(value)) {
...
function checkBufferSupport$1() {
  if (typeof Buffer === "undefined") {
    throw new TypeError("[unstorage] Buffer is not supported!");
  }
}
const BASE64_PREFIX$1 = "base64:";
function serializeRaw$1(value) {
  if (typeof value === "string") {
    return value;
  }
  checkBufferSupport$1();
  const base64 = Buffer.from(value).toString("base64");
  return BASE64_PREFIX$1 + base64;
}
function deserializeRaw$1(value) {
  if (typeof value !== "string") {
    return value;
  }
  if (!value.startsWith(BASE64_PREFIX$1)) {
    return value;
  }
  checkBufferSupport$1();
  return Buffer.from(value.slice(BASE64_PREFIX$1.length), "base64");
}
...
function defineDriver$3(factory) {
  return factory;
}

const DRIVER_NAME$3 = "memory";
const memory$1 = defineDriver$3(() => {
...
function createStorage$1(options = {}) {
  ...
  const storage = {
    ...
    hasItem(key, opts = {}) {
      ...
      return asyncCall$1(driver.hasItem, relativeKey, opts);
    },
    getItem(key, opts = {}) {
      key = normalizeKey$2(key);
      const { relativeKey, driver } = getMount(key);
      return asyncCall$1(driver.getItem, relativeKey, opts).then(
        (value) => destr$1(value)
      );
    },
    ...
    getItemRaw(key, opts = {}) {
      ...
      if (driver.getItemRaw) {
        return asyncCall$1(driver.getItemRaw, relativeKey, opts);
      }
      return asyncCall$1(driver.getItem, relativeKey, opts).then(
        (value) => deserializeRaw$1(value)
      );
    },
    async setItem(key, value, opts = {}) {
      ...
      await asyncCall$1(driver.setItem, relativeKey, stringify$1(value), opts);
      if (!driver.watch) {
        onChange("update", key);
      }
    },
    ...
    async setItemRaw(key, value, opts = {}) {
      ...
      if (driver.setItemRaw) {
        await asyncCall$1(driver.setItemRaw, relativeKey, value, opts);
      } else if (driver.setItem) {
        await asyncCall$1(driver.setItem, relativeKey, serializeRaw$1(value), opts);
      } else {
        return;
      }
      if (!driver.watch) {
    ...
    async removeItem(key, opts = {}) {
      ...
      await asyncCall$1(driver.removeItem, relativeKey, opts);
    ...
    async getMeta(key, opts = {}) {
      ...
      if (driver.getMeta) {
        Object.assign(meta, await asyncCall$1(driver.getMeta, relativeKey, opts));
      }
      if (!opts.nativeOnly) {
        const value = await asyncCall$1(
          driver.getItem,
          relativeKey + "$",
          opts
    ...
    async getKeys(base, opts = {}) {
      ...
      for (const mount of mounts) {
        const rawKeys = await asyncCall$1(
    ...
    async clear(base, opts = {}) {
      ...
      await Promise.all(
        getMounts(base, false).map(async (m) => {
          if (m.driver.clear) {
            return asyncCall$1(m.driver.clear, m.relativeBase, opts);
          }
    ...
    async dispose() {
      await Promise.all(
        Object.values(context.mounts).map((driver) => dispose$1(driver))
      );
    },
    ...
    async unmount(base, _dispose = true) {
      ...
      if (_dispose) {
        await dispose$1(context.mounts[base]);
      }
...
async function dispose$1(driver) {
  if (typeof driver.dispose === "function") {
    await asyncCall$1(driver.dispose);
  }
}
...
function defineDriver$2(factory) {
  return factory;
}

const DRIVER_NAME$2 = "memory";
const memory = defineDriver$2(() => {
  const data = /* @__PURE__ */ new Map();
  return {
    name: DRIVER_NAME$2,
    getInstance: () => data,
...
const _assets = {
  ["nuxt-og-image:fonts:Inter-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2024-12-03T19:09:02.556Z"}
  },
  ["nuxt-og-image:fonts:Inter-700.ttf.base64"]: {
    import: () => import('../raw/Inter-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2024-12-03T19:09:02.556Z"}
  }
};
...
const unstorage_47drivers_47fs_45lite = defineDriver$1((opts = {}) => {
  if (!opts.base) {
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"C:\\Users\\akaas\\Documents\\GitHub\\MadeWithNuxtjs\\.data\\kv"}));
...
function normalizeSiteConfig(config) {
  ...
  if (config.url && !hasProtocol$1(config.url, { acceptRelative: true, strict: false }))
...
function useNitroOrigin(e) {
  ...
  {
    host = getRequestHost$1(e, { xForwardedHost: true }) || host;
    protocol = getRequestProtocol$1(e, { xForwardedProto: true }) || protocol;
  }
...
function createNitroRouteRuleMatcher$2() {
  ...
  return (path) => {
    return defu$1({}, ..._routeRulesMatcher.matchAll(
      ...
      withoutBase$1(withoutTrailingSlash$1(withoutQuery$2(path)), app.baseURL)
    ).reverse());
  };
}

function getSiteRobotConfig(e) {
  const query = getQuery$2(e);
  const hints = [];
...
function getPathRobotConfig(e, options) {
  ...
  if (usingNuxtContent && nitroApp._robots?.nuxtContentUrls?.has(withoutTrailingSlash$1(path))) {
    return {
      indexable: false,
      rule: robotsDisabledValue,
      debug: {
...
const _htPeN73M21 = defineNitroPlugin(async (nitroApp) => {
...
const basicReporter$1 = {
  log(logObj) {
    (console[logObj.type] || console.log)(...logObj.args);
  }
};
function createConsola$1(options = {}) {
  return createConsola$2({
    reporters: [basicReporter$1],
    ...options
  });
}
const consola$1 = createConsola$1();
consola$1.consola = consola$1;

const logger$1 = createConsola$1({
...
const _ai9Ap8Nwrj = defineNitroPlugin(async (nitroApp) => {
  ...
  if (usingNuxtContent) {
    ...
    if (urls && Array.isArray(urls) && urls.length) {
      urls.forEach((url) => nuxtContentUrls.add(withoutTrailingSlash$1(url)));
    }
  }
...
function fetchIsland(e, component, props) {
  const hashId = hash$1([component, props]);
...
function createNitroRouteRuleMatcher$1() {
  ...
  return (path) => {
    return defu$1({}, ..._routeRulesMatcher.matchAll(
      // radix3 does not support trailing slashes
      withoutBase$1(withoutTrailingSlash$1(withoutQuery$1(path)), app.baseURL)
    ).reverse());
  };
}
...
function resolvePathCacheKey(e, path) {
  const siteConfig = e.context.siteConfig.get();
  const basePath = withoutTrailingSlash$1(withoutLeadingSlash(normalizeKey$2(path || e.path)));
  return [
...
const _rFIcofaIij = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _dRMnMEd4nM = (function(nitro) {
...
const assets = {
  "/favicon.ico": {
    ...
    "mtime": "2024-11-20T11:30:23.446Z",
    "size": 4286,
    "path": "../public/favicon.ico"
  },
  "/icon.png": {
    "type": "image/png",
    "etag": "\"bac7-doDhMAWZd1l77RXj9LYbLthYNTY\"",
    "mtime": "2024-11-25T09:56:10.876Z",
    "size": 47815,
    "path": "../public/icon.png"
  },
  "/icon_old.png": {
    "type": "image/png",
js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"315-2GMogKI6iZMlqkVaf+4bO3PgSOA\"",
    "mtime": "2024-12-03T19:09:19.045Z",
    "size": 789,
    "path": "../public/_nuxt/DZaY4m9r.js"
  },
  "/_nuxt/entry.DR2YmDLW.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"10a-Mtra/Vm7MmFFVVZAGGLEdubB34k\"",
    "mtime": "2024-12-03T19:09:19.044Z",
    "size": 266,
    "path": "../public/_nuxt/entry.DR2YmDLW.css"
  },
  "/_nuxt/error-404.fMMPvRi1.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"de4-bhiYTc3A2xdfU7PFK6TxOwqpA40\"",
    "mtime": "2024-12-03T19:09:19.044Z",
    "size": 3556,
    "path": "../public/_nuxt/error-404.fMMPvRi1.css"
  },
  "/_nuxt/error-500.CL16SKQw.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"75c-8p80IROfQNDURULTLNGfAJKXN0U\"",
    "mtime": "2024-12-03T19:09:19.044Z",
    "size": 1884,
    "path": "../public/_nuxt/error-500.CL16SKQw.css"
  },
  "/_nuxt/FSX2VlPl.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1b38-zI1UscUx6KdSZXBGNneFDYudmws\"",
    "mtime": "2024-12-03T19:09:19.045Z",
    "size": 6968,
    "path": "../public/_nuxt/FSX2VlPl.js"
  },
  "/_nuxt/St6gQvyE.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"114c3-A437ULCivblxkBPSC8+OjNG45/0\"",
    "mtime": "2024-12-03T19:09:19.045Z",
    "size": 70851,
    "path": "../public/_nuxt/St6gQvyE.js"
  },
  "/_nuxt/yHZ2E8b8.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2c0d-x0KMI8WRLJ+itQZ9XRF6UI9te8w\"",
    "mtime": "2024-12-03T19:09:19.045Z",
    "size": 11277,
    "path": "../public/_nuxt/yHZ2E8b8.js"
  },
  "/_nuxt/ZXTNiSTc.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"d57-ATmir046LOyu+Ui45p0jqC0NVUk\"",
    "mtime": "2024-12-03T19:09:19.045Z",
    "size": 3415,
    "path": "../public/_nuxt/ZXTNiSTc.js"
  },
  "/_nuxt/builds/latest.json": {
    "type": "application/json",
    "etag": "\"47-wl0q++Y/YxjnifChsgn+YxHHlgc\"",
    "mtime": "2024-12-03T19:09:24.266Z",
    "size": 71,
    "path": "../public/_nuxt/builds/latest.json"
  },
  "/_nuxt/builds/meta/2dae6628-e2fe-46ea-8c0e-bf7b4284757f.json": {
    "type": "application/json",
    "etag": "\"8b-9ZFzW47Cun65jj1xcRIkwfEgwHs\"",
    "mtime": "2024-12-03T19:09:24.266Z",
    "size": 139,
    "path": "../public/_nuxt/builds/meta/2dae6628-e2fe-46ea-8c0e-bf7b4284757f.json"
  }
};
...
const _oOWQRJ = eventHandler((event) => {
...
const collections = {
  'mdi': () => import('@iconify-json/mdi/icons.json', { assert: { type: 'json' } }).then(m => m.default),
};

const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _N9SsO6 = defineCachedEventHandler(async (event) => {
...
const _SxzVP0 = defineEventHandler(async (e) => {
...
const _9XSIvo = defineEventHandler(async (e) => {
...
const _dBw35j = defineEventHandler(async (e) => {
  ...
  return function(path) {
    for (const v of [{ rules: exclude, result: false }, { rules: include, result: true }]) {
      ...
      if (stringRules.length > 0) {
        ...
        const routeRulesMatcher = toRouteMatcher$1(createRouter$2({ routes, strictTrailingSlash: false }));
...
const _D19Vho = defineEventHandler(async (e) => {
  ...
  const canonicalQuery = getQuery$3(referrer).canonical;
  const isShowingCanonical = typeof canonicalQuery !== "undefined" && canonicalQuery !== "false";
  const conditionalTips = [
    'You are looking at a <a href="https://developer.mozilla.org/en-US/docs/Web/XSLT/Transforming_XML_with_XSLT/An_Overview" style="color: #398465" target="_blank">XML stylesheet</a>. Read the <a href="https://nuxtseo.com/sitemap/guides/customising-ui" style="color: #398465" target="_blank">docs</a> to learn how to customize it. View the page source to see the raw XML.',
    `URLs missing? Check Nuxt Devtools Sitemap tab (or the <a href="${withQuery$1("/__sitemap__/debug.json", { sitemap: sitemapName })}" style="color: #398465" target="_blank">debug endpoint</a>).`
  ];
...
function preNormalizeEntry(_e, resolvers) {
  ...
  try {
    e._path = e._abs ? parseURL$1(e.loc) : parsePath$1(e.loc);
  } catch (e2) {
    e2._path = null;
  }
  if (e._path) {
    const query = parseQuery$1(e._path.search);
    const qs = stringifyQuery$1(query);
    e._relativeLoc = `${encodePath$1(e._path?.pathname)}${qs.length ? `?${qs}` : ""}`;
    if (e._path.host) {
      e.loc = stringifyParsedURL$1(e._path);
    } else {
      ...
      if (!e._i18nTransform && !e.alternatives?.length) {
        ...
        if (autoI18n.differentDomains) {
          ...
          for (const l of autoI18n.locales) {
            let loc = joinURL$1(`/${l.code}`, e._pathWithoutPrefix);
            ...
            const newEntry = preNormalizeEntry({
              ...
              alternatives: [{ code: "x-default", _hreflang: "x-default" }, ...autoI18n.locales].map((locale) => {
                ...
                if (autoI18n.strategy === "prefix") {
                  href = joinURL$1("/", code, e._pathWithoutPrefix);
...
const _z1SbDD = defineEventHandler(async (e) => {
  const runtimeConfig = useSimpleSitemapRuntimeConfig();
  const { sitemaps } = runtimeConfig;
  if ("index" in sitemaps) {
    return sendRedirect(e, withBase$1("/sitemap_index.xml", useRuntimeConfig().app.baseURL), 301);
  }
...
const _e7jOwz = lazyEventHandler(() => {
...
const _lazy_sizEjg = () => import('../routes/renderer.mjs');
const _lazy_X0SE3N = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_0utbTX = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '', handler: _oOWQRJ, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_sizEjg, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _N9SsO6, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _SxzVP0, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _9XSIvo, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _dBw35j, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _D19Vho, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _z1SbDD, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_X0SE3N, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_0utbTX, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_0utbTX, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _e7jOwz, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_sizEjg, lazy: true, middleware: false, method: undefined }
];
...
export { withTrailingSlash as $, setHeader as A, hash$1 as B, parseURL$1 as C, setResponseHeader as D, proxyRequest as E, sendRedirect as F, resolveContext as G, H3Error$1 as H, withBase as I, withQuery as J, destr as K, baseURL as L, hasProtocol as M, isScriptProtocol as N, joinURL as O, createError as P, defuFn as Q, defu as R, sanitizeStatusCode as S, createDefu as T, withoutTrailingSlash as U, toRouteMatcher as V, createRouter as W, parseURL as X, withoutBase as Y, stringifyQuery as Z, withLeadingSlash as _, trapUnhandledNodeErrors as a, hasTrailingSlash as a0, hash as a1, decodeHtml as a2, logger as a3, toBase64Image as a4, withBase$1 as a5, createConsola$1 as a6, htmlDecodeQuotes as a7, defu$1 as a8, fontCache as a9, encodeParam as aa, isEqual as ab, encodePath as ac, parseQuery as ad, useNitroApp as b, defineRenderHandler as c, destr$1 as d, buildAssetsURL as e, createError$2 as f, getQuery$2 as g, getRouteRules as h, getResponseStatus as i, getResponseStatusText as j, defineEventHandler as k, prefixStorage as l, useStorage as m, useNitroOrigin as n, emojiCache as o, publicAssetsURL as p, useOgImageRuntimeConfig as q, readBody as r, setupGracefulShutdown as s, toNodeListener as t, useRuntimeConfig as u, fetchIsland as v, normaliseFontInput as w, withTrailingSlash$1 as x, handleCacheHeaders as y, setHeaders as z };
