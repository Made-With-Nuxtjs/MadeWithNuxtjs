import { _ as __nuxt_component_0 } from './nuxt-link-DI51IVC8.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-f94ff8c7><div class="fixed left-0 right-0 spotlight z-10" data-v-f94ff8c7></div><div class="max-w-520px text-center z-20" data-v-f94ff8c7><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-f94ff8c7>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-f94ff8c7>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-f94ff8c7>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.14.1592_@parcel+watcher@2.5.0_@types+node@22.10.1_ioredis@5.4.1_magicast@0.3.5_rollup@_imcsu66opj3u5rjpg5gyivrq3m/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f94ff8c7"]]);

export { error404 as default };
//# sourceMappingURL=error-404-C0kaqQ8n.mjs.map
