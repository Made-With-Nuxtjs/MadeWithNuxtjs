...
import { c as defineRenderHandler, e as buildAssetsURL, p as publicAssetsURL, g as getQuery, f as createError, h as getRouteRules, u as useRuntimeConfig, i as getResponseStatus, j as getResponseStatusText, r as readBody, d as destr, b as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"link":[{"rel":"icon","href":"/icon.png","type":"image/png","sizes":"360x360"}],"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{}};
