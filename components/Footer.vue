<template>
  <footer class="mx-auto w-full transition-transform fixed bottom-0" :class="{ 'translate-y-full': !isFooterVisible, 'translate-y-0': isFooterVisible }" style="transition: transform 0.5s ease-in-out;">
    <div class="px-5 md:px-20 lg:px-24 xl:px-20 py-[11px] md:py-[9px] lg:py-[9px] xl:py-[10px] lg:flex xl:flex sm:justify-between md:justify-between lg:justify-between xl:justify-between bg-light-background-tertiary dark:bg-dark-background-tertiary md:flex md:items-center">
